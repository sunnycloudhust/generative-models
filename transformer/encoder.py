...
class Encoder(nn.Module):
    def __init__(self, self_attention, mask, cross_attention, d_model, d_ff,
...
if __name__ == '__main__':
    ...
    encoder = Encoder(self_attention, mask, cross_attention, d_model, d_ff, num_head, bias, dropout)
